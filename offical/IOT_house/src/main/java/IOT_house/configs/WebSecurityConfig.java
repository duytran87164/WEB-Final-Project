    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/user/**","/user/profile/**").hasAuthority("ROLE_USER") // Người dùng có quyền USER
            ...
            .formLogin(login -> login
                ...
                .failureUrl("/home/login?error") // Nếu đăng nhập thất bại, quay lại trang login với lỗi
                .permitAll()
            )
